          ...
          >
            <div className="mb-8">
              <div className="flex justify-between items-center">
                ...
                <Button className="bg-gradient-to-r from-cyan-600 to-blue-700 text-white">
                  ...
                  {users.map((user, index) => (
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        <div className="h-12 w-12 bg-gradient-to-r from-cyan-600 to-blue-700 rounded-full flex items-center justify-center">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="text-right">
                          <p className="text-sm font-medium">{user.datasetsAccessed} datasets</p>
